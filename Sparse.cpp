...
{
	int p[100];
	int i,k,fasttranspose[100][3],q[100];
	for(i=0;i<s[0][2];i++)
		{
			p[i]=0;
		}
	...
	for(i=1;i<=s[0][2];i++)
	{
		fasttranspose[q[s[i][1]]][0]=s[i][1];
		fasttranspose[q[s[i][1]]][1]=s[i][0];
		fasttranspose[q[s[i][1]]][2]=s[i][2];
		q[s[i][1]]++;
	}
	  cout<<s[0][1]<<"\t";
	  cout<<s[0][0]<<"\t";
	  ...
	  for(k=1;k<=s[0][2];k++)
		{
		  cout<<fasttranspose[k][0]<<"\t";
		  cout<<fasttranspose[k][1]<<"\t";
		  cout<<fasttranspose[k][2]<<"\t";
		  cout<<endl;
		}
